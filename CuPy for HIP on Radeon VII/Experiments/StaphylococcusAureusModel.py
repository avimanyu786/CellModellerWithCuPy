...
def setup(sim):
    ...
    biophys = CLBacterium2CuPyTestWithDoublePrecision(sim, jitter_z=True, rho=1.0039, u=0.02, gammacoeff=0.47, max_planes=1)
...
def init(cell):
    ...
    cellVol = numpy.divide ( numpy.multiply ( numpy.power ( cell_lens[cell.cellType] , 3 ) , math.pi ) , 6.0 )
...
def update(cells):
    ...
    for (id, cell) in cells.iteritems():
        ...
        #cell.growthRate = numpy.random.uniform(0.0,1.0)
        ...
        cell.color = [0.0 , numpy.random.uniform(0.8, 1.0), 1.0]
...
def divide(parent, d1, d2):
    ...
    cell_lens = {0: numpy.random.uniform(0.8, 1.0)}
    d1.targetVol = numpy.add ( numpy.divide ( numpy.multiply ( numpy.power ( cell_lens[parent.cellType] , 3 ) , math.pi ) , 6.0 ) , numpy.random.uniform (0.0 , 1.5) )
    cell_lens = {0: numpy.random.uniform(0.8, 1.0)}
    d2.targetVol = numpy.add ( numpy.divide ( numpy.multiply ( numpy.power ( cell_lens[parent.cellType] , 3 ) , math.pi ) , 6.0 ) , numpy.random.uniform (0.0 , 1.5) )
