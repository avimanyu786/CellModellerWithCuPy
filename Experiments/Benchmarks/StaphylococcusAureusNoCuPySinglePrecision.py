...
def setup(sim):
    ...
    #biophys = CLBacterium2WithComputeNeighbours(sim, jitter_z=True, gamma=0.943666, max_planes=1, max_cells=100000)
    biophys = CLBacterium2WithComputeNeighbours(sim, jitter_z=True, rho=1.0039, u=0.02, gammacoeff=0.47, max_planes=1, max_cells=20000)
